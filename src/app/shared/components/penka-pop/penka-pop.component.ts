...
@Component({
    selector: 'app-penka-pop',
    templateUrl: './penka-pop.component.html',
    styleUrls: ['./penka-pop.component.scss']
})
export class PenkaPopComponent implements OnInit, OnDestroy {
    ...
    goWatch(penkaId): void {
        this.router.navigate(['/penka/view/' + penkaId]).catch();
    }
